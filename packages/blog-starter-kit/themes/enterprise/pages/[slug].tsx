...
const request = typeof window === 'undefined' ? null : require('graphql-request').default;
...
export const getStaticPaths: GetStaticPaths = async () => {
	...
	// Mock document object to prevent graphql-request from accessing it during server-side rendering
